...
import 'package:seller_apps/screen/chart.dart';
...
class _HomeItemState extends State<HomeItem> {
  List<TextEditingController> request = <TextEditingController>[];
          ...
          child: Padding(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  for (var i = 0; i < 4; i++) {
                    request.add(TextEditingController());
                  }
                  return Padding(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: const <Widget>[
                Text('Apakah kamu yakin ingin membelinya?'),
              ],
            ),
          ),
          actions: <Widget>[
